...
Notificacion::Notificacion(TipoNotificacion t) : _idCliente(0), _empezar(0), _turnoDe(0),_sumaPuntos(make_tuple(0, 0)),_tipoNotificacion(t) {
...
Notificacion Notificacion::nuevaUbicar(IdCliente id, const Ocurrencia& oc) {
